 const loader = document.getElementById("loader");
    ...
    // Manejar loader y mostrar login
    ...
    // Función abrir modal cotización con modelo
    ...
    // Scroll suave para anclas ya con scroll-behavior CSS
    ...
    // Animar tarjetas al hacer scroll (IntersectionObserver)
    ...
    // Datos autos para detalles modal
    const detallesAutos = {
      "Koenigsegg Jesko": {
        precio: "$3,000,000",
